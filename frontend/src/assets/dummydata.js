...
export const teamMembers = [
    {
        ...
        delay: 0.1,
        social: {
            twitter: "https://x.com/TheVikasKhanna?t=5YkzxIRwY4XyOqIqD8xDtw&s=09",
            instagram: "https://www.instagram.com/vikaskhannagroup?igsh=dmR5bmNhbHV0dThm/",
            facebook: "https://github.com/JEETMAHANTA",
            linkedin: "https://www.linkedin.com/",
        },
    },
    {
        name: "Chef Ranveer Brar",
        role: "Fusion & modern plating Chef",
        img: IA5,
        bio: "World Baking Champion | French desserts expert",
        delay: 0.3,
        social: {
            twitter: "https://x.com/ranveerbrar?t=De_VD1s3-RmCduQW1YEYDA&s=09",
            instagram: "https://www.instagram.com/ranveer.brar?igsh=emE1dmN6bjBmaDMz",
            facebook: "https://github.com/JEETMAHANTA",
            linkedin: "https://www.linkedin.com/in/ranveerbrar?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
        },
    },
    {
        ...
        role: "Fusion Chef",
        img: IA6,
        bio: "5th generation fusion chef | Traditional techniques",
        delay: 0.5,
        social: {
            twitter: "https://x.com/SanjeevKapoor?t=1ma52rA3b07AobewgYp_Qw&s=09",
            instagram: "https://www.instagram.com/sanjeevkapoor?igsh=ZXJxNjlienQ0OWZz",
            facebook: "https://github.com/JEETMAHANTA",
            linkedin: "https://www.linkedin.com/company/chef-sanjeev-kapoor/",
        },
    },
];
...
export const socialIcons = [
    { icon: FaFacebook, link: 'https://github.com/JEETMAHANTA', color: '#3b5998', label: 'Facebook' },
    { icon: FaInstagram, link: 'https://www.instagram.com/03jeet.mahanta?igsh=MWxwcTlxazc4dHZmag==', color: '#E1306C', label: 'Instagram' },
    { icon: FaXTwitter, link: 'https://x.com/jeetmahanta03?t=7E3XEBBPMjjoOfp7_fkVyA&s=09', color: '#000', label: 'X' },
    { icon: FaLinkedin, link: 'https://www.linkedin.com/in/jeet-mahanta-ab7b23317?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app', color: '#0077B5', label: 'LinkedIn' },
];
