...
const ListItems = () => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        const { data } = await axios.get('https://friendlyfoodie-backend.onrender.com/api/items');
        setItems(data);
      } catch (err) {
  ...
  const handleDelete = async (itemId) => {
    ...
    try {
      await axios.delete(`https://friendlyfoodie-backend.onrender.com/api/items/${itemId}`);
